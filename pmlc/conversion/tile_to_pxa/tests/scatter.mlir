...
func @scatter1d(%arg0: tensor<8xf32>, %arg1: tensor<4xsi32>, %arg2: tensor<4xf32>) -> tensor<8xf32> {
  %0 = tile.scatter %arg0 %arg1 %arg2 {axis = 0 : index, updateMode = 0 : i64} : (tensor<8xf32>, tensor<4xsi32>, tensor<4xf32>) -> tensor<8xf32>
...
func @scatter3d(%arg0: tensor<4x4x4xf32>, %arg1: tensor<2xsi32>, %arg2: tensor<2x4x4xf32>) -> tensor<4x4x4xf32> {
  %0 = tile.scatter %arg0 %arg1 %arg2 {axis = 0 : index, updateMode = 0 : i64} : (tensor<4x4x4xf32>, tensor<2xsi32>, tensor<2x4x4xf32>) -> tensor<4x4x4xf32>
