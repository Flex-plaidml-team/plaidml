...
void ConvertGpuLaunchFuncToVulkanCalls::hostExecutionTime(Location loc, OpBuilder builder,
							  mlir::LLVM::CallOp &timerBefore,
							  mlir::LLVM::CallOp &timerAfter) {
...
void ConvertGpuLaunchFuncToVulkanCalls::hostExecutionTimeTillNow(Location loc, OpBuilder builder,
								 mlir::LLVM::CallOp &timerBefore) {
  mlir::LLVM::CallOp timerAfter;
