...
//                                           ::testing::ValuesIn(body_condition), ::testing::ValuesIn(trip_count),
//                                           ::testing::ValuesIn(inputs), ::testing::ValuesIn(netPrecisions),
...
//                        Combine(Values(true), ValuesIn(static_loop_types), Values<int64_t>(7),
//                                Values<InferenceEngine::SizeVector>({2, 1, 4}),
//                                Values<InferenceEngine::Precision>(Precision::FP32, Precision::I32),
//                                Values(CommonTestUtils::DEVICE_PLAIDML)));
using namespace testing;
INSTANTIATE_TEST_CASE_P(smoke_TrivialLoop, TrivialLoopTest,
                        Combine(Values<InferenceEngine::Precision>(Precision::FP32, Precision::I32),
                                Values<InferenceEngine::SizeVector>({2, 3, 4}), Values(CommonTestUtils::DEVICE_PLAIDML)));
